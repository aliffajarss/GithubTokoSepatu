...
<link rel="apple-touch-icon" href="<?php echo e(asset('img/apple-touch-icon-72x72.png')); ?>">
<link rel="apple-touch-icon" href="<?php echo e(asset('img/apple-touch-icon-114x114.png')); ?>">
    ...
    <div class="container">
      ...
      <div class="row header"><!-- Begin Header -->
        ...
        <div class="span5 logo">
            <a href="/"><img src="<?php echo e(asset('img/piccolo-logo.png')); ?>" alt="" /></a>
           <h5>Toko Sepatu</h5>
        </div>
        ...
        <div class="span7 navigation">
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li><a href="<?php echo e(url('/pilihan',$data->id)); ?>"><?php echo e($data->jenis_sepatu); ?></a></li>
    ...
    <div class="row headline"><!-- Begin Headline -->
        ...
        <div class="span5">
            <div class="flexslider">
              <ul class="slides">
                <li><img src="<?php echo e(asset('img/sapatu/sepatu.jpg')); ?>" alt=""></li>
                <li><img src="<?php echo e(asset('img/sapatu/nb2.jpg')); ?>" alt=""></li>
                <li><img src="<?php echo e(asset('img/sapatu/nb1.jpg')); ?>}" alt=""></li>
                <li><img src="<?php echo e(asset('img/sapatu/nb3.jpg')); ?>" alt=""></li>
                <li><img src="<?php echo e(asset('img/sapatu/images.jpg')); ?>" alt=""></li>
                <li><img src="<?php echo e(asset('img/sapatu/j.jpg')); ?>" alt="" ></li>
              </ul>
            </div>
        </div>
            ...
            <ul class="gallery-post-grid holder">
                ...
                <li  class="span3 gallery-item" data-id="id-1" data-type="illustration">
                        ...
                        <a href="<?php echo e(url('gallery')); ?>">
                            <img src="<?php echo e(url('uploadgambar')); ?>/<?php echo e($data->gambar); ?>" class="img-responsive">
                            
                            <!-- 
                            <?php echo e($data->warna); ?>

                            <?php echo e($data->harga_jual); ?> -->
                            
                        </a>
                        <span class="project-details"><?php echo e($data->merk); ?>.</span>
                    </li>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    <!-- Gallery Item 1 -->
                <li  class="span3 gallery-item" data-id="id-1" data-type="illustration">
